...
drop table consumption_sch.order_item_fact;
...
USING (
    ...
    FROM 
    clean_sch.order_item oi
    LEFT JOIN 
    clean_sch.orders o ON oi.Order_ID_fk = o.Order_ID
    LEFT JOIN 
    clean_sch.delivery d ON o.Order_ID = d.Order_ID_fk
    LEFT JOIN 
