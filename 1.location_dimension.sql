use role swiggy_de;
use schema swiggy.stage_sch;
use warehouse swiggy_wh;



--creating table in raw format
...
-- creating stream for capturing changes
...
--loading data into raw location table
...
-- Level 2
-- creating cleansed data  table in clean_sch 
...
-- creating second stream to track changes in the second table
...
--csv_stg/delta/location/delta-day01-2rows-add.csv
